...
<html lang="{{ $page->language ?? 'en' }}">
    ...
    <body class="font-sans antialiased">
        <div class="bg-aspab-blue text-white">
            <div class="container mx-auto flex flex-col md:flex-row items-center justify-between md:py-6 md:px-2">
                ...
                <nav id="nav-menu" class="flex items-start text-xs pb-2 md:pb-0">
                    <a href="{{ trim($page->baseUrl, '/') }}/join" class="aspab-button mx-1 px-1">Join</a>
                    <a href="{{ trim($page->baseUrl, '/') }}/about" class="aspab-button mx-1 px-1">About</a>
                    <a href="{{ trim($page->baseUrl, '/') }}/newsletter" class="aspab-button mx-1 px-1">Newsletter</a>
                    <a href="{{ trim($page->baseUrl, '/') }}/conference" class="aspab-button mx-1 px-1">Conference</a>
                    <a href="{{ trim($page->baseUrl, '/') }}/funding" class="aspab-button mx-1 px-1">Funding</a>
                </nav>
            </div>
        </div>

        <div class="bg-aspab-blue-gray text-slate-800">
            <div id="main" class="container mx-auto flex flex-col py-3 px-2">
                @yield('body')
            </div>
        </div>

        <div id="footer" class="bg-aspab-blue text-white">
            <div class="container flex mx-auto justify-between align-center py-2 px-2 text-sm">
                ...
                <div class="flex items-center">
                    <a href="https://twitter.com/ASPABites" class="text-white hover:text-aspab-highlight">
